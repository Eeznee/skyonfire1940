...
[ExecuteInEditMode]
[AddComponentMenu("Sof Components/Undercarriage/Bars Dual Link")]
public class DualLink : MechanicalLink
{
    ...
    public override void PrecomputeValues()
    {
    ...
    {
        if (!link1.tr || !link2.tr || link1.tr.root != link2.tr.root) return;

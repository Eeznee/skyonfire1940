...
public class BombardierSeat : CrewSeat
{
    ...
    public override Vector3 LookingDirection => transform.root.TransformDirection(new Vector3(0f, -1f, 0.5f));
    ...
    public override void PlayerUpdate(CrewMember crew)
    {
        ...
        bombsight.Operate();
        forcedYawInput = -ControlsManager.bomber.Rudder.ReadValue<float>() * maxYawInput;
    }

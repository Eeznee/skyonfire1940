...
public class BombsightUI : MonoBehaviour
{
    ...
    private void Reload()
    {
        ...
        //Bomb bay toggle
        bombBayToggle.gameObject.SetActive(Player.aircraft.hydraulics.bombBay);
        if(bombBayToggle.gameObject.activeInHierarchy) bombBayToggle.Toggle(Player.aircraft.hydraulics.bombBay.state == 0f);
    ...
    void Update()
    {
        ...
        bombsAlertToggle.Toggle(!Player.aircraft.hydraulics.bombBay || Player.aircraft.hydraulics.bombBay.state == 1f);
    ...
    {
        ControlsManager.Action("BombBay");
    }
    public void ToggleMode()
    {
        ControlsManager.Action("BombsightMode");
    }
    public void ToggleQuantity()
    {
        ControlsManager.Action("BombsightQuantity");
    }
    public void ToggleInterval()
    {
        ControlsManager.Action("BombsightInterval");
    }
}

...
public class IndicatorsList : MonoBehaviour
{
    ...
    {
        UpdateSettings();
        SofSettingsSO.OnUpdateSettings += UpdateSettings;
    }
    ...
    {
        gsp = SofSettingsSO.CurrentSettings.gsp;
        ias = SofSettingsSO.CurrentSettings.ias;
        roc = SofSettingsSO.CurrentSettings.climbRate;
        alt = SofSettingsSO.CurrentSettings.altitude;
        thr = SofSettingsSO.CurrentSettings.throttle;
        ammo = SofSettingsSO.CurrentSettings.ammo;
        fuel = SofSettingsSO.CurrentSettings.fuel;
        gfr = SofSettingsSO.CurrentSettings.gforce;
        hdg = SofSettingsSO.CurrentSettings.heading;
        temp = SofSettingsSO.CurrentSettings.temperature;
    }
    public string Text()
    {

...
namespace UnityEngine.InputSystem.OnScreen
{
    public class TiltInput : OnScreenControl
    {
        ...
        const int averageAmount = 10;

        private float lastPitch = 0f;
        private static TiltInput instance;
...
//#endif
        ...
        private void Start()
        {
            ...
            fullPitchAngle = pitchTiltAngle * 100f / SofSettingsSO.CurrentSettings.tiltSensY;
            fullRollAngle = rollTiltAngle * 100f / SofSettingsSO.CurrentSettings.tiltSensX;
        }
        ...
        {
            if (!instance) return;
            instance.pitchZeroing = instance.GetTilt(0f).y;
        }

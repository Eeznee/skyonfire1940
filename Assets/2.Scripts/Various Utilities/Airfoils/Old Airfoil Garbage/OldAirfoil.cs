...
[CreateAssetMenu(fileName = "New Airfoil Profile", menuName = "SOF/Deprecated/Old Airfoil")]
public class OldAirfoil : ScriptableObject
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(OldAirfoil))]
public class AirfoilPresetEditor : Editor
{
    public override void OnInspectorGUI()
    {
        serializedObject.Update();
        OldAirfoil foil = (OldAirfoil)target;
        //
        GUI.color = Color.yellow;
        EditorGUILayout.HelpBox("Settings", MessageType.None);
        GUI.color = GUI.backgroundColor;
        foil.type = (OldAirfoil.AirfoilType)EditorGUILayout.EnumPopup("Airfoil Type", foil.type);
        ...
        if (foil.type == OldAirfoil.AirfoilType.Asymetric)
        {

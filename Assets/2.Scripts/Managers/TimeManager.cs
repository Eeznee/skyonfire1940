...
public class TimeManager : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        bool tiltInput = Extensions.IsMobile && SofSettingsSO.CurrentSettings.mobileControlsMode == 0;
        SetPause(tiltInput);
    }
    ...
    private void Update()
    {
        float input = -ControlsManager.cam.TimeScaleRelative.ReadValue<float>();

...
public class MechanicalAudio : AudioVisual
{
    ...
    public void Update()
    {
        ...
        if (aircraft.data.ias > 50f) VibrationsManager.SendVibrations(Mathf.InverseLerp(aircraft.foil.maxAngle * 0.9f, aircraft.foil.maxAngle * 1f, data.angleOfAttack), 0.3f, aircraft);

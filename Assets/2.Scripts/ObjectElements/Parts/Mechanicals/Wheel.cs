    ...
    void FixedUpdate()
    {
        ...
        if (isGrounded)
        {
            ...
            if (force > wheel.suspensionSpring.spring)
                GetComponentInParent<Fuselage>().Rip();
        }
...
public class WheelEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        wheel.material = EditorGUILayout.ObjectField("Part Material", wheel.material, typeof(PartMaterial), false) as PartMaterial;

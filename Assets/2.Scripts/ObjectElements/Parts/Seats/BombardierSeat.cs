...
public class BombardierSeat : CrewSeat
{
    ...
    public override void PlayerUpdate(CrewMember crew)
    {
        ...
        //Player inputs
        float elevationInput = PlayerActions.General().Pitch.ReadValue<float>();
        float sideInput = PlayerActions.General().Roll.ReadValue<float>();
    ...
    public override void PlayerFixed(CrewMember crew)
    {
        ...
        aircraft.controlInput.y = -PlayerActions.General().Rudder.ReadValue<float>() * maxYawInput;
    }

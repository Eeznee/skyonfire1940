...
public class RandomAerodynamics : SofComponent
{
    ...
    private void FixedUpdate()
    {
        ...
        Vector3 lift = Aerodynamics.Lift(rb.velocity, data.tas.Get, transform.up, data.density.Get, area, coefficients.y, 1f);
        Vector3 drag = Aerodynamics.Drag(rb.velocity, data.tas.Get, data.density.Get, area, coefficients.x, 1f);

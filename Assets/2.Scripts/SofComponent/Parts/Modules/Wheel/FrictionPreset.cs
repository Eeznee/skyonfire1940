...
public class FrictionPreset : ScriptableObject
{
    ...
    public GameObject frictionEffect;
    ...
    public float SideFriction(RaycastHit hit, CustomWheel wheel)
    {
...
public class FrictionPresetEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.ObjectField(serializedObject.FindProperty("frictionEffect"),typeof(GameObject));

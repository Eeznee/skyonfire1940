...
public class Wing : ShapedAirframe
{
    ...
    public AeroSurface splitFoilSurface;
    ...
    public override void Initialize(SofComplex _complex)
    {
        ...
        if (skinMesh)
        {
            skin = WingSkin.CreateSkin(this, skinMesh);
        }
    }
    ...
    public override void UpdateAerofoil()
    {
        ...
        if (split)
        {
            ...
            foilSurface = new ComplexAeroSurface(this, splitQuad[0], foil);
            splitFoilSurface = new ComplexAeroSurface(this, splitQuad[1], foil);
        }
    }
...
#if UNITY_EDITOR
    private Color AirfoilSurfaceColor(AeroSurface surface)
    {

...
public class ComplexAero : Aero
{
    ...
    public ComplexAero(SofAirframe _airframe, Quad _quad, Airfoil _airfoil) : base(_airframe, _quad, _airfoil)
    {
    ...
    {
        flapsInput = airframe.aircraft && airframe.aircraft.flaps ? airframe.aircraft.flaps.state : 0f;

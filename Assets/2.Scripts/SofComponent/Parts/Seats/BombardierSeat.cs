...
public class BombardierSeat : CrewSeat
{
    ...
    public override void PlayerUpdate(CrewMember crew)
    {
        ...
        //Player inputs
        Vector2 cameraInput = PlayerActions.cam.Rotate.ReadValue<Vector2>();
        ...
        speedSetting = data.gsp.Get;
        relativeAltSetting = data.altitude.Get - targetAltitude;
        ...
        switch (viewMode)
        {
            case 0:
                ...
                break;
            case 1:
                angle += cameraInput.y * Time.deltaTime * rotationSpeed;
                sideAngle += cameraInput.x * Time.deltaTime * rotationSpeed;
                break;
            case 2:
                angle += cameraInput.y * Time.deltaTime * rotationSpeed;
                sideAngle = 0f;
    ...
    public override void PlayerFixed(CrewMember crew)
    {
        ...
        aircraft.controlValue.y = -PlayerActions.bomber.Rudder.ReadValue<float>() * maxYawInput;
    }

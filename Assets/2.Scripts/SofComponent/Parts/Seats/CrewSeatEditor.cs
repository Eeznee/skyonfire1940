...
public class CrewSeatEditor : Editor
{
    ...
    static bool showCameraPovs = true;
    static bool showHeadPos = true;
    ...
    public override void OnInspectorGUI()
    {
        ...
        showCameraPovs = EditorGUILayout.Foldout(showCameraPovs, "Player Camera Pos", true, EditorStyles.foldoutHeader);
        if (showCameraPovs)
        {
        ...
        showHeadPos = EditorGUILayout.Foldout(showHeadPos, "Head Positions", true, EditorStyles.foldoutHeader);
        if (showHeadPos)
        {
            EditorGUI.indentLevel++;
            HeadPositionsGUI();
        ...
        if (showAudio)
        {
            ...
            EditorGUILayout.Slider(audioRatio, 0f, 1f, new GUIContent("Cockpit Audio Ratio"));
            if (seat.canopy)
    ...
    protected virtual void HeadPositionsGUI()
    {
        EditorGUILayout.PropertyField(defaultPov, new GUIContent("Default Pos"));
    }

...
public class MeshCombiner : MonoBehaviour
{
    ...
    public class SofMesh
    {
        ...
        public static Mesh RemoveMesh(Mesh mesh,List<Mesh> subMeshes,int indexToRemove)
        {
            ...
            mesh.vertices = mesh.vertices.RemoveElements(vertIndex, removedMesh.vertices.Length);
            mesh.triangles = mesh.triangles.RemoveElements(trisIndex, removedMesh.triangles.Length);

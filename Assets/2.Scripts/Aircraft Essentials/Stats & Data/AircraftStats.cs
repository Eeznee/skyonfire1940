...
public class AircraftStats
{
    ...
    public float maximumStableAoA { get; private set; }
    public float minimumStableAoA { get; private set; }
    ...
    private void ComputeWingStats()
    {
        ...
        maximumStableAoA = mainAirfoil.HighPeakAlpha - aircraft.StallMarginAngle + wingsIncidence;
        minimumStableAoA = mainAirfoil.LowPeakAlpha + aircraft.StallMarginAngle + wingsIncidence;
    }

    public float MaxStableAoA(float pitchSign)
    {
        return pitchSign >= 0f ? maximumStableAoA : minimumStableAoA;
    }
    private void ComputeRollRate()
    {
        ...
        foreach (Wing wing in wings)
        {
            ...
            float airfoilGradient = wing.Airfoil.GradientRadians();

...
public class PostProcessFX : MonoBehaviour
{
    ...
    private void UpdateLightWeight()
    {
        ...
        fullColor.a = Mathf.Max(Mathf.Abs(blackout), (1f - PlayerManager.player.crew.Integrity) * damageVignetteIntensityLW);
    ...
    {
        float crewHealth = PlayerManager.player.crew.Integrity;
        //Vignette
    ...
    void Update()
    {
        ...
        float a = veinsTransparencyMax * Mathv.SmoothStart(1f - PlayerManager.player.crew.Integrity, 2);

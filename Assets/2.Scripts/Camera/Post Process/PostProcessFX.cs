...
public class PostProcessFX : MonoBehaviour
{
    ...
    {
        SofSettingsSO.OnUpdateSettings += UpdateGraphicsQuality;
    }
    ...
    {
        lightWeight = SofSettingsSO.CurrentSettings.graphicsPreset == 0;
    ...
    {
        bool active = UIManager.gameUI == GameUI.Pause;
        if (depthOfField.active != active) depthOfField.active = active;

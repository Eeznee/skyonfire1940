...
public class AirfoilSection : ScriptableObject
{
    public struct SpecificVariables
    {
        ...
        public void Compute(bool computeAll, AirfoilSection _section, float _ar, float _flapFraction, float _flapAngle)
        {
...
#if UNITY_EDITOR
[CustomEditor(typeof(AirfoilSection))]
public class AirfoilSectionEditor : Editor
{
    public override void OnInspectorGUI()
    {
        serializedObject.Update();
        AirfoilSection foil = (AirfoilSection)target;
